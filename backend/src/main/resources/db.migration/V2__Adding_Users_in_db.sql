...
INSERT into project (link_to_git, name, progress, team_id) values ('https://github.com/TimofeyKononovich/currency_exchange.git','currency_exchange',0,1);
INSERT into user_team values (1,1);
INSERT into user_team values (1,2);
INSERT into task (date_time, description, spent_time, status, title, project_id) values ('2014-11-25 03:00:00','Exchange Application1','2015-11-25 04:00:00','COMPLETED','Application1',1);
INSERT into task (date_time, description, spent_time, status, title, project_id) values ('2013-10-27 02:00:00','Exchange Application2','2014-11-25 05:00:00','POSTPONED','Application1',1);
...
INSERT into project (link_to_git, name, progress, team_id) values ('https://github.com/TimofeyKononovich/lab_9.git','Lab_9',25,2);
...
INSERT into task (date_time, description, spent_time, status, title, project_id) values ('1970-02-01 08:30:10','Lab_09','2003-05-19 20:04:00','ASSIGNED','Application2',2);
INSERT into task (date_time, description, spent_time, status, title, project_id) values ('1970-03-01 23:01:00','Lab_09','1989-04-01 20:04:00','DISCUSSION','Application2',2);
INSERT into task (date_time, description, spent_time, status, title, project_id) values ('1970-01-01  23:09:00','Lab_09','1999-02-23 09:00:00','CLOSED','Application2',2);
INSERT into task (date_time, description, spent_time, status, title, project_id) values ('1970-04-01 12:01:00','Lab_09','2000-01-24 12:00:08','CANCELED','Application2',2);
...
#Project number 3
INSERT into team (number_of_persons) values (2);
INSERT into project (link_to_git, name, progress, team_id) values ('https://github.com/TimofeyKononovich/lab_8.git','Lab_8',50,3);
INSERT into user_team values (3,7);
INSERT into user_team values (3,8);
INSERT into task (date_time, description, spent_time, status, title, project_id) values ('2001-10-04 20:12:33','Lab_08','2002-01-01 00:00:00','CLOSED','Application3',3);
INSERT into task (date_time, description, spent_time, status, title, project_id) values ('2001-08-04 13:32:09','Lab_08','2003-03-26 00:00:00','COMPLETED','Application3',3);
...
INSERT into task (date_time, description, spent_time, status, title, project_id) values ('1999-06-25 00:00:00','Lab_05','2001-03-05 00:00:00','NEW','Application1',4);
